...
export default function AboutPage() {
  return (
    <div className="max-w-6xl mx-auto p-7 m-7 rounded-xl shadow-2xl border-2 border-blue-300/60 bg-white shadow-blue-200/60" id="about">
      <h2 className="text-3xl font-bold text-center pt-7" data-aos="fade-up">Tentang Rekayasa Perangkat Lunak</h2>
      <div className="flex flex-row items-center m-3 p-3 pt-0.5" >
        <div className="basis-[60%] p-7 m-7" data-aos="fade-left">
        ...
        <div className="basis-[40%] flex justify-end p-4" data-aos="fade-right">
          <img src="/src/assets/hero-image-about.jpg" alt="About RPL" className="w-full max-w-3xl h-auto rounded-lg" />
        </div>
      </div>
    </div>
  )
