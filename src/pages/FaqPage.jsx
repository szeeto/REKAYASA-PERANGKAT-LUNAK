    ...
    <div className="max-w-6xl mx-auto p-7 m-7 rounded-xl shadow-2xl border-2 border-purple-300/60 bg-white shadow-purple-200/60" data-aos="fade-up">
      ...
      <div className='p-3 m-3 text-bold' data-aos="fade-right">
          <div className="space-y-2" data-aos="fade-left">
            {/* FAQ 1 */}
            <details className="group [&_summary::-webkit-details-marker]:hidden" data-aos="flip-up" data-aos-delay="100">
            ...
            {/* FAQ 2 */}
            <details className="group [&_summary::-webkit-details-marker]:hidden" data-aos="flip-up" data-aos-delay="200">
              <summary className="flex cursor-pointer items-center justify-between gap-4 rounded-lg border border-gray-200 bg-white px-4 py-3 font-medium text-gray-900 hover:bg-gray-50">
            ...
            {/* FAQ 3 */}
            <details className="group [&_summary::-webkit-details-marker]:hidden" data-aos="flip-up" data-aos-delay="300">
              <summary className="flex cursor-pointer items-center justify-between gap-4 rounded-lg border border-gray-200 bg-white px-4 py-3 font-medium text-gray-900 hover:bg-gray-50">
            ...
            {/* FAQ 4 */}
            <details className="group [&_summary::-webkit-details-marker]:hidden" data-aos="flip-up" data-aos-delay="400">
              <summary className="flex cursor-pointer items-center justify-between gap-4 rounded-lg border border-gray-200 bg-white px-4 py-3 font-medium text-gray-900 hover:bg-gray-50">
            ...
            {/* FAQ 5 */}
            <details className="group [&_summary::-webkit-details-marker]:hidden" data-aos="flip-up" data-aos-delay="500">
              <summary className="flex cursor-pointer items-center justify-between gap-4 rounded-lg border border-gray-200 bg-white px-4 py-3 font-medium text-gray-900 hover:bg-gray-50">
            ...
            {/* FAQ 6 */}
            <details className="group [&_summary::-webkit-details-marker]:hidden" data-aos="flip-up" data-aos-delay="600">
              <summary className="flex cursor-pointer items-center justify-between gap-4 rounded-lg border border-gray-200 bg-white px-4 py-3 font-medium text-gray-900 hover:bg-gray-50">
